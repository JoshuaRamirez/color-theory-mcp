...
server.tool(
  'get-color-info',
  'Get comprehensive information about a color including all formats, perceptual values, and analysis',
...
server.tool(
  'get-color-name',
  'Find the closest CSS named color to a given color value',
  getColorNameSchema.shape,
  async (input) => {
...
server.tool(
  'list-named-colors',
  'List CSS named colors with optional filtering',
  listNamedColorsSchema.shape,
  async (input) => {
...
server.tool(
  'calculate-delta-e',
  'Calculate perceptual color difference (Delta-E) between two colors',
  calculateDeltaESchema.shape,
  async (input) => {
...
server.tool(
  'adjust-color',
  'Adjust a color by lightening, darkening, saturating, desaturating, or rotating hue',
  adjustColorSchema.shape,
  async (input) => {
...
server.tool(
  'generate-harmony',
  'Generate a color harmony palette (complementary, analogous, triadic, etc.)',
  generateHarmonySchema.shape,
  async (input) => {
...
server.tool(
  'generate-palette',
  'Generate a complete design system palette from a base color',
  generatePaletteSchema.shape,
  async (input) => {
...
server.tool(
  ...
  'Generate WCAG-compliant versions of colors for a given background',
  generateAccessiblePaletteSchema.shape,
  async (input) => {
...
server.tool(
  'validate-gamut',
  'Check if a color is within a specific color space gamut',
  validateGamutSchema.shape,
  async (input) => {
...
server.tool(
  'validate-print-safe',
  'Check if a color will reproduce well in CMYK print',
  validatePrintSafeSchema.shape,
  async (input) => {
...
server.tool(
  'validate-palette-harmony',
  'Analyze a palette for color harmony and distinguishability',
  validatePaletteHarmonySchema.shape,
  async (input) => {
