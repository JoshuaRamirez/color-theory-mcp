...
export async function generateAccessiblePalette(input) {
    ...
    const results = input.colors.map(colorStr => {
        ...
        // Adjust for contrast
        const adjusted = contrastService.adjustForContrast(original, background, input.level, 'normal');
...
//# sourceMappingURL=generateAccessiblePalette.js.map